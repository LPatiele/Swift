...
class MusicasTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.musicas = MusicaDAO.getlist()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let musicascell = cell as? MusicasTableViewCell{
            ...
            musicascell.artistaLabel.text = musica.nomeArtista
            musicascell.musicaLabel.text = musica.nomeMusica
        }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "mostrarDetalhes" {
            if let novaView = segue.destination as?  DetalhesMusicaViewController{
                let musica = musicas[(tableView.indexPathForSelectedRow?.row)!]
                novaView.musica = musica
